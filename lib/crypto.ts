/**
 * Lightweight, zero-dependency, synchronous SHA-256 implementation.
 * Compatible with Browser, SSR, and Worker environments without async overhead.
 */
...
export function sha256(ascii: string): string {
  ...
  // First 64 prime cube root fractional bits
  const k: number[] = [
  ...
  for (let b = 7; b >= 0; b--) {
    utf8.push((bitLength / Math.pow(2, b * 8)) & 0xff);
  }
